...
class BasicDataset(Dataset):
    def __init__(self, images_dir: Union[str, Path], masks_dir: Union[str, Path], scale: float = 1.0,
                 mask_suffix: str = ''):
...
if __name__ == "__main__":
    ...
    # 1918*1280
    dataset = CarvanaDataset(images_dir=dir_img, masks_dir=dir_mask, scale=0.25)
    print(len(dataset))
